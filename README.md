...
React.js, React Native, Node.js, JavaScript, TypeScript, Git, MySQL, HTML, WordPress, MariaDB, Redux Toolkit, Context API, Jest, RTL, Styled Components, Express.js, Docker
